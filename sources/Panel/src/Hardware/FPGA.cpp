...
void FPGA::WriteData()
{
    ...
    while (Read_READY != 0)             // \todo   сожалению, флаг готовности не работает так, как надо и если ожидать его установки в ноль, то происходит сбой передачи данных
...
void FPGA::WriteCommand(const char command[4], const char argument[6], char *file, int line)
{
