...
/*!*****************************************************************************
  ...
  @return
  */
void BigStringMono_print(char *text, uint8_t *display, uint32_t foreground)
{
	while (*text) {
		BigSymbol_print(*text, display, foreground);
...
/*!*****************************************************************************
  ...
  @return
  */
void BigStringProp_print(char *text, uint8_t *display, uint32_t foreground)
{
	while (*text) {
		uint32_t space = BigSymbol_print(*text, display, foreground);
		display += space;
		text++;
	}
}
...
/*!*****************************************************************************
  ...
  @return
  */
void BigStringMonoPad_print(char *text, uint8_t *display, 
...
/*!*****************************************************************************
  ...
  @return
  */
void BigStringPropPad_print(char *text, uint8_t *display, 
							uint32_t foreground, uint32_t background)
{
	while (*text) {
...
/*!*****************************************************************************
  ...
  */
uint32_t BigSymbol_print(uint8_t symbol, volatile uint8_t *display, uint32_t foreground)
{
...
/*!*****************************************************************************
  ...
  @return	width of symbol in pixels (for proportional string printing)
  */
uint32_t BigSymbolPad_print(uint8_t symbol, volatile uint8_t *display, 
						  uint32_t foreground, uint32_t background)
{
	assert(0x20 <= symbol && symbol <= 0x3F);
	uint16_t offs = BigCharOffs[symbol - ' '];				// offset in BigCharIndx
