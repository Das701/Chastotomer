...
rom unsigned char SET_1[]			= {3, 0x1B, 0x74, 0x11};		//Включение кириллических шрифтов
rom unsigned char SET_2[]			= {3, 0x1B, 0x74, 0x00};		//Включение стандартных шрифтов
rom unsigned char SET_3[]			= {3, 0x1B, 0x74, 0x01};		//Включение японских шрифтов
rom unsigned char INVERT_SET[]		= {3, 0x1F, 0x72, 0x01};		//Включение инверсии
rom unsigned char INVERT_RESET[]	= {3, 0x1F, 0x72, 0x00};		//Отключение инверсии
rom unsigned char CLEAR_DYSP[]		= {1, 0x0C};
rom unsigned char MIXTURE_NORM[]	= {3, 0x1F, 0x77, 0x00};		//Смешивание
rom unsigned char MIXTURE_OR[]		= {3, 0x1F, 0x77, 0x01};		//Смешивание
rom unsigned char MIXTURE_AND[]		= {3, 0x1F, 0x77, 0x02};		//Смешивание
rom unsigned char MIXTURE_XOR[]		= {3, 0x1F, 0x77, 0x03};		//Смешивание
rom unsigned char SIZE_FONT_1[]		= {5, 0x1F, 0x28, 0x67, 0x01, 0x01};		//Размер символов 6х8
rom unsigned char SIZE_FONT_2[]		= {5, 0x1F, 0x28, 0x67, 0x01, 0x02};		//Размер символов 8х16
rom unsigned char SIZE_FONT_3[]		= {5, 0x1F, 0x28, 0x67, 0x01, 0x02};		//Размер символов 16х16
rom unsigned char Kanji_On[]		= {5, 0x1F, 0x28, 0x67, 0x02, 0x01};		//Включение режима японских шрифтов
rom unsigned char Kanji_OFF[]		= {5, 0x1F, 0x28, 0x67, 0x02, 0x00};		//Отключение режима японских шрифтов

rom unsigned char SET_4[]			= {10, 0x1F, 0x28, 0x67, 0x01, 0x02, 0x1F, 0x28, 0x67, 0x02, 0x01};		//Отключение режима японских шрифтов
rom unsigned char SET_5[]			= {10, 0x1F, 0x28, 0x67, 0x01, 0x01, 0x1F, 0x28, 0x67, 0x02, 0x00};		//Отключение режима японских шрифтов

rom unsigned char Freq[]			= {17, 0x1B, 0x74, 0x00,	0x1F, 0x28, 0x67, 0x01, 0x02,	0x9F,	0x1F, 0x28, 0x67, 0x01, 0x01,	0x1B, 0x74, 0x11};
rom unsigned char Tau[]				= {22, 0x1F, 0x28, 0x67, 0x01, 0x02, 0x1F, 0x28, 0x67, 0x02, 0x01,		0x83, 0xD1,		0x1F, 0x28, 0x67, 0x01, 0x01, 0x1F, 0x28, 0x67, 0x02, 0x00};
rom unsigned char T[]				= {22, 0x1F, 0x28, 0x67, 0x01, 0x02, 0x1F, 0x28, 0x67, 0x02, 0x01,		0x83, 0xB1,		0x1F, 0x28, 0x67, 0x01, 0x01, 0x1F, 0x28, 0x67, 0x02, 0x00};

rom unsigned char Action[]				= {6, 0x02, 0x44, 0x00, 0x53, 0x00, 0x08};
...
char Image(unsigned char x, unsigned char y, near rom unsigned char * data);
...
rom char *rom ImageChar[] =	{image_1, image_2, image_3, image_4, image_5, image_6, image_7, image_8, image_9}; //0x90 + индекс
