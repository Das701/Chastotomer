...
#define CURRENT_CHANNEL_IS_A        (CURRENT_CHANNEL == Channel::_A)
#define CURRENT_CHANNEL_IS_B        (CURRENT_CHANNEL == Channel::_B)
#define CURRENT_CHANNEL_IS_A_OR_B   (CURRENT_CHANNEL_IS_A || CURRENT_CHANNEL_IS_B)
#define CURRENT_CHANNEL_IS_C        (CURRENT_CHANNEL == Channel::_C)
#define CURRENT_CHANNEL_IS_D        (CURRENT_CHANNEL == Channel::_D)

#define TYPE_SYNCH(ch)              (set.typeSynch[(ch)])
#define TYPE_SYNCH_A                (TYPE_SYNCH(Channel::_A))
#define TYPE_SYNCH_B                (TYPE_SYNCH(Channel::_B))

#define LEVEL_SYNCH(ch)             (set.levelSynch[ch][TYPE_SYNCH(ch)])
#define LEVEL_SYNCH_A               (LEVEL_SYNCH(Channel::_A))
#define LEVEL_SYNCH_B               (LEVEL_SYNCH(Channel::_B))
