...
static pCHAR FuncCoupling(pCHAR buffer)
{
    ...
    SCPI_PROCESS_ARRAY(coupling, Channel::Current()->set.couple.Set((InputCouple::E)i)); //-V2563
}
...
static pCHAR FuncFilter(pCHAR buffer)
{
    ...
    SCPI_PROCESS_ARRAY(filter, Channel::Current()->set.modeFilter.Set((ModeFilter::E)i)); //-V2563
}
